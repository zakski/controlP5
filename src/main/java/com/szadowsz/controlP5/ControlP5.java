...
import com.szadowsz.controlP5.drawable.Tooltip;
...
import com.szadowsz.controlP5.input.keys.ChordFunction;
import com.szadowsz.controlP5.input.keys.ChordKey;
import com.szadowsz.controlP5.input.keys.KeyWrangler;
...
public class ControlP5 extends ControlP5Base implements CColourInterface<ControlP5> {
	...
	protected KeyWrangler keys; // key handling, separate so can be used by other libs/classes
	 ...
	 */
	public ControlP5(final PApplet theParent, MousePointer mousePointer, KeyWrangler keyStorage) {
		papplet = theParent;
		mouse = mousePointer;
		keys = keyStorage;
		init();
	...
	public ControlP5(final PApplet theParent, MousePointer mousePointer, KeyWrangler keyStorage, PFont thePFont) {
	...
	public ControlP5(final PApplet theParent) {
		this(theParent, new MousePointer(theParent.mouseX,theParent.mouseY), new KeyWrangler(5000));
	}
	...
	public boolean isMousePressed (){ return mouse.isPressed();}
	...
	public char getKey(){return keys.getKey();}
	...
	public int mousePX() {return mouse.getPX();}
	...
	public int mouseDY() {	return mouse.getDY();}

	public void mapShortcut(ChordFunction keyShortcut, int... nkeys) {
		keys.mapShortcut(new ChordKey(nkeys),keyShortcut);
