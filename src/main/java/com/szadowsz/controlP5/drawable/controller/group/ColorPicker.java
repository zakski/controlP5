 ...
 */
public class ColorPicker extends ControlGroup<ColorPicker> implements CPlugToInterface<ColorPicker> {
	...
	public ColorPicker(ControlP5 theControlP5, CGroup<?> theParent, String theName, int theX, int theY, int theWidth, int theHeight) {
		...
		sliderRed.setColourBackground(0xff660000);
		sliderRed.setColourForeground(0xffaa0000);
		sliderRed.setColourActive(0xffff0000);
		...
		sliderGreen.setColourBackground(0xff006600);
		sliderGreen.setColourForeground(0xff00aa00);
		sliderGreen.setColourActive(0xff00ff00);
		...
		sliderBlue.setColourBackground(0xff000066);
		sliderBlue.setColourForeground(0xff0000aa);
		sliderBlue.setColourActive(0xff0000ff);
		...
		sliderAlpha.setColourBackground(0xff666666);
		sliderAlpha.setColourForeground(0xffaaaaaa);
		sliderAlpha.setColourActive(0xffffffff);
		...
		_myPlug = cp5.papplet;
		_myPlugName = getName();
		if (!cp5.getBroadcaster().plug(_myPlug, this, _myPlugName, new Class[] { int.class })) {
			_myPlug = null;
		}
		broadcast = true;
	}
	...
	public void controlEvent(CEvent theEvent) {
		if (broadcast) {
			_myArrayValue[theEvent.getInterface().getId()] = theEvent.getInterface().getValue();
			broadcast();
		}
	}

	private ColorPicker broadcast() {
		CEvent ev = new CEvent(this, CActionType.BROADCAST);
		setValue(getColorValue());
		cp5.getBroadcaster().broadcast(ev);
		if (_myPlug != null) {
			try {
	 ...
	 */
	@Override
	public ColorPicker setColourValue(int theColor) {
		setArrayValue(new float[] { theColor >> 16 & 0xff, theColor >> 8 & 0xff, theColor >> 0 & 0xff, theColor >> 24 & 0xff });
		return this;
	}

	public int getColorValue() {
		return 0xffffffff & (int) (_myArrayValue[3]) << 24 | (int) (_myArrayValue[0]) << 16 | (int) (_myArrayValue[1]) << 8
	...
	@Override
	public ColorPicker plugTo(Object[] theObjects) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public ColorPicker plugTo(Object[] theObjects, String theTargetName) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public ColorPicker unplugFrom(Object[] theObjects) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public ColorPicker unplugFrom(Object theObject) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public ColorPicker addPlug(CPlug thePlug) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public ColorPicker removePlug(CPlug thePlug) {
		// TODO Auto-generated method stub
		return null;
	}
}
