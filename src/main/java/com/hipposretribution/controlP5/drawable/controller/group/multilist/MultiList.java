package com.hipposretribution.controlP5.drawable.controller.group.multilist;
 ...
 */
public class MultiList extends CElement<MultiList> implements MultiListInterface, CListener {

	/*
	 * TODO reflection does not work properly. TODO add an option to remove MultiListButtons
	 */

	protected CTab _myTab;
	...
	public MultiList(ControlP5 theControlP5, CTab theParent, String theName, int theX, int theY, int theWidth,
			int theHeight) {
	...
	void setDirection(int theDirection) {
		_myDirection = (theDirection == ControlP5.LEFT) ? ControlP5.LEFT : ControlP5.RIGHT;
